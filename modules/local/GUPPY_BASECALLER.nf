process GUPPY_BASECALLER {
    ...
    stub:
        """
        mkdir basecall_${meta.id}_summary && cp /Users/mohamedmahgoub/Documents/Lab/dev/wgsnano/test/nf-core-wgsnano/test_data/stubs/sequencing_summary.txt basecall_${meta.id}_summary
        mkdir basecall_${meta.id}_bams && cp /Users/mohamedmahgoub/Documents/Lab/dev/wgsnano/test/nf-core-wgsnano/test_data/stubs/${meta.id}/basecall_${meta.id}/bams/*.bam basecall_${meta.id}_bams
        cp /Users/mohamedmahgoub/Documents/Lab/dev/wgsnano/test/nf-core-wgsnano/test_data/stubs/${meta.id}/basecall_${meta.id}/fastq/${meta.id}.fastq.gz ${meta.id}.fastq.gz
